...
`java-app001` が開発用です。リポジトリの `java-app001` は最終版（04版）となっています。

`java-app001-00` から `java-app001-04` までが 1 の記事用で、`java-app001-05` は 2 の記事用です（この時点では 03 版までのコードしか含んでいません）。
...
- `java-app001-00/` から `java-app001-05/`: `java-app001/` の更新履歴（この時点では java-app001-03 までしか含んでいません）。
